...
if not skipSetup:
    ...
    if pick == 'Automatic':
        ...
        main = Main("Deer Detection [Automatic setup]", videoSource, modelSource, forceReload, captureDetection, detectionThreshold, captureFrequency, output_dim, headless_mode, resize_flag)
    ...
    # The user defines the settings in the application
        ...
        main = Main("Deer Detection [Manual setup]", videoSource, modelSource, forceReload, captureDetection, detectionThreshold, captureFrequency, output_dim, headless_mode, resize_flag)
    ...
    # Mode for gathering images for further training of model
        ...
        main = Main("Deer Detection [Image Collection]", videoSource, modelSource, forceReload, captureDetection, detectionThreshold, captureFrequency, output_dim, headless_mode, resize_flag)
    ...
    main = Main("Deer Detection [Skipped setup, running on config]", videoSource, modelSource, forceReload, captureDetection, detectionThreshold, captureFrequency, output_dim, headless_mode, resize_flag)
